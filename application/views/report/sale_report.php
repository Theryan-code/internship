                            ...
                            <div class="col-md-4">
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" id="invoice" name="invoice" value="<?=$post['invoice']?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            foreach ($row->result() as $r => $data) { ?>
                                <tr>
                                    ...
                                    <td class="text-center" width="200px">
                                        ...
                                        <a href="<?=site_url('sale/print/'.$data->sale_id)?>" target="_blank" class="btn btn-xs btn-info">
